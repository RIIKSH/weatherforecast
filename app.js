...
app.get("/",(req,res)=>{
    ...
    const query = "Delhi";
    const apiKey = "8fa56fa1e7dadfd204c7e7d8407b7e21";
    const units = "metric";
...
app.post("/",function(req,res){
    ...
    //    const query="Delhi";
        const url =`https://api.openweathermap.org/data/2.5/weather?lat=${req.body.lattitude}&lon=${req.body.longitude}&units=metric&appid=8fa56fa1e7dadfd204c7e7d8407b7e21`;
